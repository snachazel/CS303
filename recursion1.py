...
#  Description: A set of tutorial exercises dealing with recursion
...
def strDist(str, sub): 
  ...
  elif str[:len(sub)] == sub and str[-len(str):] == sub:
